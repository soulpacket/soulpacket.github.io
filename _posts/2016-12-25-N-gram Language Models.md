...
* 例如，对于句子`the rat ate the cheese /s`，我们可以来试着计算一下经add-one平滑后的 P(ate|rat)以及 P(ate|cheese)，即 <img src="http://chart.googleapis.com/chart?cht=tx&chl=P(ate%7Crat)%3D%5Cfrac%7BC(ratate)%2B1%7D%7BC(rat)%2B%7CV%7C%7D%3D%5Cfrac%7B2%7D%7B6%7D" style="border:none;" />
